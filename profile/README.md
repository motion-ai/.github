...
+ Use the QuickStart (see below) on RaspberryPi4, Jetson Nano, or Intel/AMD host; see [guide](https://github.com/motion-ai/motion-ai/blob/master/docs/QUICKSTART.md.
